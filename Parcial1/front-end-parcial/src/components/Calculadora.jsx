...
function Calculadora() {
    ...
    return (
        <div className="container">
            <h1 id="txtCalculadora">PARCIAL</h1>
            <form>
                ...
                <input type="text" className="number" onChange={(e) => setNumber3(e.target.value)} value={number3}  /><br />
                
                <input type="checkbox" className="check" checked={checked4} onChange={() => setChecked4(!checked4)} />
                <input type="text" className="number" onChange={(e) => setNumber4(e.target.value)} value={number4} /><br />
                
                <input type="checkbox" className="check" checked={checked5} onChange={() => setChecked5(!checked5)} />
                <input type="text" className="number" onChange={(e) => setNumber5(e.target.value)} value={number5} /><br />
                
                <input type="checkbox" className="check" checked={checked6} onChange={() => setChecked6(!checked6)} />
                <input type="text" className="number" onChange={(e) => setNumber6(e.target.value)} value={number6} /><br />

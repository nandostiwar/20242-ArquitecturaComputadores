...
function Calculadora() {
    ...
    return (
        <div className="container">
            ...
            <button className="btnEnviar" onClick={handleSortAsc}>Ascendente</button>
            <button className="btnEnviar" onClick={handleSortDesc}>Descendente</button>
            ...
            />
            <button className="btnEnviar" onClick={handleEvaluate}>OK</button>
